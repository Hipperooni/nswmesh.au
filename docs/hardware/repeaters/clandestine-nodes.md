...
import clandestineShedLight from '@site/static/img/hardware/repeaters/clandestine-shed-light.jpeg';
import clandestineCamoPaint from '@site/static/img/hardware/repeaters/clandestine-camo-paint.png';
import clandestineCamoTape from '@site/static/img/hardware/repeaters/clandestine-camo-tape.jpeg';
import clandestineSolarLight from '@site/static/img/hardware/repeaters/clandestine-solar-light.jpeg';
import clandestineSitePlanner from '@site/static/img/hardware/repeaters/clandestine-site-planner.jpeg';
import clandestineElectricalEquipment from '@site/static/img/hardware/repeaters/clandestine-electrical-equipment.jpeg';
...
<img className="nswmesh-doc-image" src={clandestineShedLight} alt="Node disguised as a Shed Light" />
...
<img className="nswmesh-doc-image" src={clandestineCamoPaint} alt="Camo spray paint using colours like greens, beiges or brown" />
...
<img className="nswmesh-doc-image" src={clandestineCamoTape} alt="Camo tape and camo netting can also be used to hide a node" />
...
<img className="nswmesh-doc-image" src={clandestineSolarLight} alt="Node disguised as a solar light for urban environments" />
...
<img className="nswmesh-doc-image nswmesh-doc-image--wide" src={clandestineSitePlanner} alt="The Meshtastic Site Planner for signal simulation" />

The Meshtastic Site Planner, a free tool, can simulate signal range based on terrain and obstacles, helping optimise placement at your remote location. The Meshcore tools menu in the app has included tools such as the coverage tool and line of site tool helping choose the best remote node location.
...
<img className="nswmesh-doc-image" src={clandestineElectricalEquipment} alt="Node disguised as electrical equipment in urban environments" />
